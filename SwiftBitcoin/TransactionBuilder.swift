...
public class TransactionBuilder {
    ...
    public var transaction: Transaction {
        ...
        for input in transactionMessage.inputs {
            ...
            let transactionInput = Transaction.Input(outPoint: input.outPoint, scriptSignature: scriptSignature(key: input.userKey!), sequence: input.sequence)
    ...
    private func scriptSignature(key: CoinKey) -> NSData {
        let signature = produceDERSignature(key: key)
